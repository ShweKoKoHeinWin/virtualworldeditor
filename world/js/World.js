class World {
    ...
    draw(ctx, viewPoint, showStartMarking = true, renderRadius = 1000) {
        ...
        const objects = [...this.buildings, ...this.trees].filter(i => i.base.distanceToPoint(viewPoint) < renderRadius); //combine all objects
        objects.sort(       
            (a, b) => {
